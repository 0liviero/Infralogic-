...
checkAccess('read', 'printers');

$tableName = 'printers'; // Nazwa tabeli
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Wyszukaj urządzenie..." data-type="printers"/>
