...
checkAccess('read', 'devices');

$tableName = 'devices'; // Nazwa tabeli
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Wyszukaj urządzenie..." data-type="devices"/>
            ...
            <form class="export-form" method="post" action="<?php echo BASE_URL; ?>/includes/export.php">
                <input type="hidden" name="table_name" value="devices"> 
