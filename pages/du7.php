...
checkAccess('read', 'du7');

$tableName = 'du7'; // Nazwa tabeli
...
$columnNames = [
    'id' => 'ID',
    'name' => 'Nazwa ',
    'ip_address' => 'Adres Maszyna',
    'vnc_address' => 'Adres Ekran',
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Wyszukaj urządzenie..." data-type="du7"/>
            ...
            <form class="export-form" method="post" action="<?php echo BASE_URL; ?>/includes/export.php">
                <input type="hidden" name="table_name" value="du7"> 
